...
static const _Respawn_Event_type_support_symbol_names_t _Respawn_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, stonefish_ros2, srv, Respawn_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, stonefish_ros2, srv, Respawn_Event)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, stonefish_ros2, srv, Respawn_Event)() {
  return &::stonefish_ros2::srv::rosidl_typesupport_c::Respawn_Event_message_type_support_handle;
}
...
static const rosidl_service_type_support_t Respawn_service_type_support_handle = {
  ...
  &Respawn_Request_message_type_support_handle,
  &Respawn_Response_message_type_support_handle,
  &Respawn_Event_message_type_support_handle,
