  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = stonefish_ros2::msg::EventArray;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Member: events
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; i++) {
      stonefish_ros2::msg::typesupport_fastrtps_cpp::cdr_serialize_key(
        ros_message.events[i],
        cdr);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Member: events
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        stonefish_ros2::msg::typesupport_fastrtps_cpp::get_serialized_size_key(
        ros_message.events[index], current_alignment);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Member: events
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        stonefish_ros2::msg::typesupport_fastrtps_cpp::max_serialized_size_key_Event(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
