...
static char stonefish_ros2__msg__DVLBeam__FIELD_NAME__range[] = "range";
static char stonefish_ros2__msg__DVLBeam__FIELD_NAME__range_covariance[] = "range_covariance";
static char stonefish_ros2__msg__DVLBeam__FIELD_NAME__velocity[] = "velocity";
static char stonefish_ros2__msg__DVLBeam__FIELD_NAME__velocity_covariance[] = "velocity_covariance";
static char stonefish_ros2__msg__DVLBeam__FIELD_NAME__pose[] = "pose";

static rosidl_runtime_c__type_description__Field stonefish_ros2__msg__DVLBeam__FIELDS[] = {
  {
    {stonefish_ros2__msg__DVLBeam__FIELD_NAME__range, 5, 5},
    {
  ...
  {
    {stonefish_ros2__msg__DVLBeam__FIELD_NAME__range_covariance, 16, 16},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_DOUBLE,
      0,
      0,
  ...
  {
    {stonefish_ros2__msg__DVLBeam__FIELD_NAME__velocity, 8, 8},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_DOUBLE,
      0,
      0,
  ...
  {
    {stonefish_ros2__msg__DVLBeam__FIELD_NAME__velocity_covariance, 19, 19},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_DOUBLE,
      0,
      0,
  ...
  {
    {stonefish_ros2__msg__DVLBeam__FIELD_NAME__pose, 4, 4},
    {
...
static rosidl_runtime_c__type_description__IndividualTypeDescription stonefish_ros2__msg__DVLBeam__REFERENCED_TYPE_DESCRIPTIONS[] = {
  {
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      ...
      {stonefish_ros2__msg__DVLBeam__FIELDS, 5, 5},
    },
    {stonefish_ros2__msg__DVLBeam__REFERENCED_TYPE_DESCRIPTIONS, 6, 6},
  };
  if (!constructed) {
...
stonefish_ros2__msg__DVLBeam__get_individual_type_description_source(
  const rosidl_message_type_support_t * type_support)
{
  (void)type_support;
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static bool constructed = false;
  if (!constructed) {
    sources[0] = *stonefish_ros2__msg__DVLBeam__get_individual_type_description_source(NULL),
