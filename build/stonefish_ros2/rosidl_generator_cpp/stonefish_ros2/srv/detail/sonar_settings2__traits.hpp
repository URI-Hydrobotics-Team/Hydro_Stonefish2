...
inline void to_flow_style_yaml(
  const SonarSettings2_Event & msg,
  std::ostream & out)
{
  out << "{";
  // member: info
...
inline std::string to_yaml(const SonarSettings2_Event & msg, bool use_flow_style = false)
{
  std::ostringstream out;
  if (use_flow_style) {
    to_flow_style_yaml(msg, out);
...
[[deprecated("use stonefish_ros2::srv::to_block_style_yaml() instead")]]
inline void to_yaml(
  const stonefish_ros2::srv::SonarSettings2_Event & msg,
  std::ostream & out, size_t indentation = 0)
{
  stonefish_ros2::srv::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use stonefish_ros2::srv::to_yaml() instead")]]
inline std::string to_yaml(const stonefish_ros2::srv::SonarSettings2_Event & msg)
{
  return stonefish_ros2::srv::to_yaml(msg);
}

template<>
inline const char * data_type<stonefish_ros2::srv::SonarSettings2_Event>()
{
  return "stonefish_ros2::srv::SonarSettings2_Event";
}

template<>
inline const char * name<stonefish_ros2::srv::SonarSettings2_Event>()
{
  return "stonefish_ros2/srv/SonarSettings2_Event";
}

template<>
struct has_fixed_size<stonefish_ros2::srv::SonarSettings2_Event>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<stonefish_ros2::srv::SonarSettings2_Event>
  : std::integral_constant<bool, has_bounded_size<service_msgs::msg::ServiceEventInfo>::value && has_bounded_size<stonefish_ros2::srv::SonarSettings2_Request>::value && has_bounded_size<stonefish_ros2::srv::SonarSettings2_Response>::value> {};

template<>
struct is_message<stonefish_ros2::srv::SonarSettings2_Event>
  : std::true_type {};
