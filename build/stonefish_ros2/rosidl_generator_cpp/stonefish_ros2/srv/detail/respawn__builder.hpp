...
class Init_Respawn_Event_response
{
public:
  explicit Init_Respawn_Event_response(::stonefish_ros2::srv::Respawn_Event & msg)
  : msg_(msg)
  {}
  ::stonefish_ros2::srv::Respawn_Event response(::stonefish_ros2::srv::Respawn_Event::_response_type arg)
  {
...
private:
  ::stonefish_ros2::srv::Respawn_Event msg_;
};

class Init_Respawn_Event_request
{
public:
  explicit Init_Respawn_Event_request(::stonefish_ros2::srv::Respawn_Event & msg)
  : msg_(msg)
  {}
  Init_Respawn_Event_response request(::stonefish_ros2::srv::Respawn_Event::_request_type arg)
  {
    msg_.request = std::move(arg);
    return Init_Respawn_Event_response(msg_);
  }
...
class Init_Respawn_Event_info
{
public:
  Init_Respawn_Event_info()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_Respawn_Event_request info(::stonefish_ros2::srv::Respawn_Event::_info_type arg)
  {
    msg_.info = std::move(arg);
    return Init_Respawn_Event_request(msg_);
  }
...
template<>
inline
auto build<::stonefish_ros2::srv::Respawn_Event>()
{
  return stonefish_ros2::srv::builder::Init_Respawn_Event_info();
}
