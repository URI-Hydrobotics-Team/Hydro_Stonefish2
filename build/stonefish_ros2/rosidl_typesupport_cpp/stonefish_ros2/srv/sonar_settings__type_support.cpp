...
static const _SonarSettings_Event_type_support_symbol_names_t _SonarSettings_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, stonefish_ros2, srv, SonarSettings_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, stonefish_ros2, srv, SonarSettings_Event)),
  }
};
...
{
  return &::stonefish_ros2::srv::rosidl_typesupport_cpp::SonarSettings_Event_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, stonefish_ros2, srv, SonarSettings_Event)() {
  return get_message_type_support_handle<stonefish_ros2::srv::SonarSettings_Event>();
}
...
static const rosidl_service_type_support_t SonarSettings_service_type_support_handle = {
  ...
  ::rosidl_typesupport_cpp::get_message_type_support_handle<stonefish_ros2::srv::SonarSettings_Request>(),
  ::rosidl_typesupport_cpp::get_message_type_support_handle<stonefish_ros2::srv::SonarSettings_Response>(),
  ::rosidl_typesupport_cpp::get_message_type_support_handle<stonefish_ros2::srv::SonarSettings_Event>(),
