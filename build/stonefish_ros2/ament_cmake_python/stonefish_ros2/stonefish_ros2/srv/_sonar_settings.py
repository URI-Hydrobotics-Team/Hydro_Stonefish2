...
class Metaclass_SonarSettings_Event(type):
    """Metaclass of message 'SonarSettings_Event'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__sonar_settings__event
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__sonar_settings__event
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__sonar_settings__event
            cls._TYPE_SUPPORT = module.type_support_msg__srv__sonar_settings__event
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__sonar_settings__event
...
class SonarSettings_Event(metaclass=Metaclass_SonarSettings_Event):
    """Message class 'SonarSettings_Event'."""
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<stonefish_ros2/SonarSettings_Request, 1>',
        'response': 'sequence<stonefish_ros2/SonarSettings_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['stonefish_ros2', 'srv'], 'SonarSettings_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['stonefish_ros2', 'srv'], 'SonarSettings_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from stonefish_ros2.srv import SonarSettings_Request
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 len(value) <= 1 and
                 all(isinstance(v, SonarSettings_Request) for v in value) and
                 True), \
                "The 'request' field must be a set or sequence with length <= 1 and each value of type 'SonarSettings_Request'"
        self._request = value
    ...
    def response(self, value):
        if self._check_fields:
            from stonefish_ros2.srv import SonarSettings_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, SonarSettings_Response) for v in value) and
                 True), \
                "The 'response' field must be a set or sequence with length <= 1 and each value of type 'SonarSettings_Response'"
...
class Metaclass_SonarSettings(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            if _sonar_settings.Metaclass_SonarSettings_Event._TYPE_SUPPORT is None:
                _sonar_settings.Metaclass_SonarSettings_Event.__import_type_support__()
...
class SonarSettings(metaclass=Metaclass_SonarSettings):
    ...
    from stonefish_ros2.srv._sonar_settings import SonarSettings_Event as Event
