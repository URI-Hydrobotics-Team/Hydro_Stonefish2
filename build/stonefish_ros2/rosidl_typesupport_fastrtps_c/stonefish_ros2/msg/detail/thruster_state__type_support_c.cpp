...
bool cdr_serialize_stonefish_ros2__msg__ThrusterState(
  const stonefish_ros2__msg__ThrusterState * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: header
  {
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_stonefish_ros2
bool cdr_deserialize_stonefish_ros2__msg__ThrusterState(
  eprosima::fastcdr::Cdr & cdr,
  stonefish_ros2__msg__ThrusterState * ros_message)
{
  // Field name: header
  {
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = stonefish_ros2__msg__ThrusterState;
    is_plain =
      (
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_stonefish_ros2
bool cdr_serialize_key_stonefish_ros2__msg__ThrusterState(
  const stonefish_ros2__msg__ThrusterState * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: header
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_stonefish_ros2
size_t get_serialized_size_key_stonefish_ros2__msg__ThrusterState(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _ThrusterState__ros_msg_type * ros_message = static_cast<const _ThrusterState__ros_msg_type *>(untyped_ros_message);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_stonefish_ros2
size_t max_serialized_size_key_stonefish_ros2__msg__ThrusterState(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const stonefish_ros2__msg__ThrusterState * ros_message = static_cast<const stonefish_ros2__msg__ThrusterState *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_stonefish_ros2__msg__ThrusterState(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  stonefish_ros2__msg__ThrusterState * ros_message = static_cast<stonefish_ros2__msg__ThrusterState *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_stonefish_ros2__msg__ThrusterState(cdr, ros_message);
}
