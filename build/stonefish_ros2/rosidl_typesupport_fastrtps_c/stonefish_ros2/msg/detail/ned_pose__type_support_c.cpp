  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const stonefish_ros2__msg__NEDPose * ros_message = static_cast<const stonefish_ros2__msg__NEDPose *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_stonefish_ros2__msg__NEDPose(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  stonefish_ros2__msg__NEDPose * ros_message = static_cast<stonefish_ros2__msg__NEDPose *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_stonefish_ros2__msg__NEDPose(cdr, ros_message);
}
