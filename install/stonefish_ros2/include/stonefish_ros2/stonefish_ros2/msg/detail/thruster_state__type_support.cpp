...
void fetch_function__ThrusterState__setpoint(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const double *>(
    get_const_function__ThrusterState__setpoint(untyped_member, index));
  auto & value = *reinterpret_cast<double *>(untyped_value);
  value = item;
}

void assign_function__ThrusterState__setpoint(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<double *>(
    get_function__ThrusterState__setpoint(untyped_member, index));
...
void fetch_function__ThrusterState__rpm(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const double *>(
    get_const_function__ThrusterState__rpm(untyped_member, index));
  auto & value = *reinterpret_cast<double *>(untyped_value);
  value = item;
}

void assign_function__ThrusterState__rpm(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<double *>(
    get_function__ThrusterState__rpm(untyped_member, index));
  const auto & value = *reinterpret_cast<const double *>(untyped_value);
  item = value;
}
...
void fetch_function__ThrusterState__thrust(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const double *>(
    get_const_function__ThrusterState__thrust(untyped_member, index));
  auto & value = *reinterpret_cast<double *>(untyped_value);
  value = item;
}

void assign_function__ThrusterState__thrust(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<double *>(
    get_function__ThrusterState__thrust(untyped_member, index));
  const auto & value = *reinterpret_cast<const double *>(untyped_value);
  item = value;
}
...
void fetch_function__ThrusterState__torque(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const double *>(
    get_const_function__ThrusterState__torque(untyped_member, index));
  auto & value = *reinterpret_cast<double *>(untyped_value);
  value = item;
}

void assign_function__ThrusterState__torque(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<double *>(
    get_function__ThrusterState__torque(untyped_member, index));
  const auto & value = *reinterpret_cast<const double *>(untyped_value);
  item = value;
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember ThrusterState_message_member_array[5] = {
  ...
  },
  {
    ...
    fetch_function__ThrusterState__setpoint,  // fetch(index, &value) function pointer
    assign_function__ThrusterState__setpoint,  // assign(index, value) function pointer
  ...
  },
  {
    ...
    fetch_function__ThrusterState__rpm,  // fetch(index, &value) function pointer
    assign_function__ThrusterState__rpm,  // assign(index, value) function pointer
  ...
  },
  {
    ...
    fetch_function__ThrusterState__thrust,  // fetch(index, &value) function pointer
    assign_function__ThrusterState__thrust,  // assign(index, value) function pointer
  ...
  },
  {
    ...
    fetch_function__ThrusterState__torque,  // fetch(index, &value) function pointer
    assign_function__ThrusterState__torque,  // assign(index, value) function pointer
