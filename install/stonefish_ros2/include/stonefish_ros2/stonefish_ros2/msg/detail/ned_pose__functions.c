...
stonefish_ros2__msg__NEDPose__create(void)
{
...
stonefish_ros2__msg__NEDPose__Sequence__init(stonefish_ros2__msg__NEDPose__Sequence * array, size_t size)
{
  ...
  if (size) {
    if (size > SIZE_MAX / sizeof(stonefish_ros2__msg__NEDPose)) {
      return false;
    }
  ...
  stonefish_ros2__msg__NEDPose__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    if (input->size > SIZE_MAX / sizeof(stonefish_ros2__msg__NEDPose)) {
      return false;
    }
