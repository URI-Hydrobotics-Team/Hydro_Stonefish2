...
void fetch_function__DVL__beams(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const stonefish_ros2::msg::DVLBeam *>(
    get_const_function__DVL__beams(untyped_member, index));
  auto & value = *reinterpret_cast<stonefish_ros2::msg::DVLBeam *>(untyped_value);
  value = item;
}
...
void assign_function__DVL__beams(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<stonefish_ros2::msg::DVLBeam *>(
    get_function__DVL__beams(untyped_member, index));
  const auto & value = *reinterpret_cast<const stonefish_ros2::msg::DVLBeam *>(untyped_value);
  item = value;
}
