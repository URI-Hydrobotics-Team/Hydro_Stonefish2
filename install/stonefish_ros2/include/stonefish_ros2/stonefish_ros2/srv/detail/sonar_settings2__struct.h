...
enum
{
  stonefish_ros2__srv__SonarSettings2_Event__request__MAX_SIZE = 1
};
// response
enum
{
  stonefish_ros2__srv__SonarSettings2_Event__response__MAX_SIZE = 1
};

/// Struct defined in srv/SonarSettings2 in the package stonefish_ros2.
typedef struct stonefish_ros2__srv__SonarSettings2_Event
{
  service_msgs__msg__ServiceEventInfo info;
  stonefish_ros2__srv__SonarSettings2_Request__Sequence request;
  stonefish_ros2__srv__SonarSettings2_Response__Sequence response;
} stonefish_ros2__srv__SonarSettings2_Event;

// Struct for a sequence of stonefish_ros2__srv__SonarSettings2_Event.
typedef struct stonefish_ros2__srv__SonarSettings2_Event__Sequence
{
