...
stonefish_ros2__srv__SonarSettings_Request__create(void)
{
...
stonefish_ros2__srv__SonarSettings_Request__Sequence__init(stonefish_ros2__srv__SonarSettings_Request__Sequence * array, size_t size)
{
  ...
  if (size) {
    if (size > SIZE_MAX / sizeof(stonefish_ros2__srv__SonarSettings_Request)) {
      return false;
    }
  ...
  stonefish_ros2__srv__SonarSettings_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    if (input->size > SIZE_MAX / sizeof(stonefish_ros2__srv__SonarSettings_Request)) {
      return false;
    }
...
stonefish_ros2__srv__SonarSettings_Response__create(void)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
...
stonefish_ros2__srv__SonarSettings_Response__Sequence__init(stonefish_ros2__srv__SonarSettings_Response__Sequence * array, size_t size)
{
  ...
  if (size) {
    if (size > SIZE_MAX / sizeof(stonefish_ros2__srv__SonarSettings_Response)) {
      return false;
    }
  ...
  stonefish_ros2__srv__SonarSettings_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    if (input->size > SIZE_MAX / sizeof(stonefish_ros2__srv__SonarSettings_Response)) {
      return false;
    }
    const size_t allocation_size =
...
bool
stonefish_ros2__srv__SonarSettings_Event__init(stonefish_ros2__srv__SonarSettings_Event * msg)
{
  if (!msg) {
    return false;
  }
  ...
  if (!service_msgs__msg__ServiceEventInfo__init(&msg->info)) {
    stonefish_ros2__srv__SonarSettings_Event__fini(msg);
    return false;
  }
  // request
  if (!stonefish_ros2__srv__SonarSettings_Request__Sequence__init(&msg->request, 0)) {
    stonefish_ros2__srv__SonarSettings_Event__fini(msg);
    return false;
  }
  // response
  if (!stonefish_ros2__srv__SonarSettings_Response__Sequence__init(&msg->response, 0)) {
    stonefish_ros2__srv__SonarSettings_Event__fini(msg);
    return false;
  }
  return true;
...
void
stonefish_ros2__srv__SonarSettings_Event__fini(stonefish_ros2__srv__SonarSettings_Event * msg)
{
  if (!msg) {
    return;
  }
  ...
  // request
  stonefish_ros2__srv__SonarSettings_Request__Sequence__fini(&msg->request);
  // response
  stonefish_ros2__srv__SonarSettings_Response__Sequence__fini(&msg->response);
}

bool
stonefish_ros2__srv__SonarSettings_Event__are_equal(const stonefish_ros2__srv__SonarSettings_Event * lhs, const stonefish_ros2__srv__SonarSettings_Event * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
  ...
  // request
  if (!stonefish_ros2__srv__SonarSettings_Request__Sequence__are_equal(
      &(lhs->request), &(rhs->request)))
  {
    return false;
  }
  // response
  if (!stonefish_ros2__srv__SonarSettings_Response__Sequence__are_equal(
...
bool
stonefish_ros2__srv__SonarSettings_Event__copy(
  const stonefish_ros2__srv__SonarSettings_Event * input,
  stonefish_ros2__srv__SonarSettings_Event * output)
{
  if (!input || !output) {
    return false;
  }
  ...
  // request
  if (!stonefish_ros2__srv__SonarSettings_Request__Sequence__copy(
      &(input->request), &(output->request)))
  {
    return false;
  }
  // response
  if (!stonefish_ros2__srv__SonarSettings_Response__Sequence__copy(
...
stonefish_ros2__srv__SonarSettings_Event *
stonefish_ros2__srv__SonarSettings_Event__create(void)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  stonefish_ros2__srv__SonarSettings_Event * msg = (stonefish_ros2__srv__SonarSettings_Event *)allocator.allocate(sizeof(stonefish_ros2__srv__SonarSettings_Event), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(stonefish_ros2__srv__SonarSettings_Event));
  bool success = stonefish_ros2__srv__SonarSettings_Event__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
void
stonefish_ros2__srv__SonarSettings_Event__destroy(stonefish_ros2__srv__SonarSettings_Event * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    stonefish_ros2__srv__SonarSettings_Event__fini(msg);
...
bool
stonefish_ros2__srv__SonarSettings_Event__Sequence__init(stonefish_ros2__srv__SonarSettings_Event__Sequence * array, size_t size)
{
  if (!array) {
    return false;
  }
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  stonefish_ros2__srv__SonarSettings_Event * data = NULL;

  if (size) {
    if (size > SIZE_MAX / sizeof(stonefish_ros2__srv__SonarSettings_Event)) {
      return false;
    }
    data = (stonefish_ros2__srv__SonarSettings_Event *)allocator.zero_allocate(size, sizeof(stonefish_ros2__srv__SonarSettings_Event), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = stonefish_ros2__srv__SonarSettings_Event__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        stonefish_ros2__srv__SonarSettings_Event__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
void
stonefish_ros2__srv__SonarSettings_Event__Sequence__fini(stonefish_ros2__srv__SonarSettings_Event__Sequence * array)
{
  if (!array) {
    return;
  }
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      stonefish_ros2__srv__SonarSettings_Event__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
stonefish_ros2__srv__SonarSettings_Event__Sequence *
stonefish_ros2__srv__SonarSettings_Event__Sequence__create(size_t size)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  stonefish_ros2__srv__SonarSettings_Event__Sequence * array = (stonefish_ros2__srv__SonarSettings_Event__Sequence *)allocator.allocate(sizeof(stonefish_ros2__srv__SonarSettings_Event__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = stonefish_ros2__srv__SonarSettings_Event__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
void
stonefish_ros2__srv__SonarSettings_Event__Sequence__destroy(stonefish_ros2__srv__SonarSettings_Event__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    stonefish_ros2__srv__SonarSettings_Event__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}

bool
stonefish_ros2__srv__SonarSettings_Event__Sequence__are_equal(const stonefish_ros2__srv__SonarSettings_Event__Sequence * lhs, const stonefish_ros2__srv__SonarSettings_Event__Sequence * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!stonefish_ros2__srv__SonarSettings_Event__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
...
bool
stonefish_ros2__srv__SonarSettings_Event__Sequence__copy(
  const stonefish_ros2__srv__SonarSettings_Event__Sequence * input,
  stonefish_ros2__srv__SonarSettings_Event__Sequence * output)
{
  if (!input || !output) {
    return false;
  }
  if (output->capacity < input->size) {
    if (input->size > SIZE_MAX / sizeof(stonefish_ros2__srv__SonarSettings_Event)) {
      return false;
    }
    const size_t allocation_size =
      input->size * sizeof(stonefish_ros2__srv__SonarSettings_Event);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    stonefish_ros2__srv__SonarSettings_Event * data =
      (stonefish_ros2__srv__SonarSettings_Event *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!stonefish_ros2__srv__SonarSettings_Event__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          stonefish_ros2__srv__SonarSettings_Event__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!stonefish_ros2__srv__SonarSettings_Event__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
