...
class Init_SonarSettings_Event_response
{
public:
  explicit Init_SonarSettings_Event_response(::stonefish_ros2::srv::SonarSettings_Event & msg)
  : msg_(msg)
  {}
  ::stonefish_ros2::srv::SonarSettings_Event response(::stonefish_ros2::srv::SonarSettings_Event::_response_type arg)
  {
...
private:
  ::stonefish_ros2::srv::SonarSettings_Event msg_;
};

class Init_SonarSettings_Event_request
{
public:
  explicit Init_SonarSettings_Event_request(::stonefish_ros2::srv::SonarSettings_Event & msg)
  : msg_(msg)
  {}
  Init_SonarSettings_Event_response request(::stonefish_ros2::srv::SonarSettings_Event::_request_type arg)
  {
    msg_.request = std::move(arg);
    return Init_SonarSettings_Event_response(msg_);
  }
...
class Init_SonarSettings_Event_info
{
public:
  Init_SonarSettings_Event_info()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_SonarSettings_Event_request info(::stonefish_ros2::srv::SonarSettings_Event::_info_type arg)
  {
    msg_.info = std::move(arg);
    return Init_SonarSettings_Event_request(msg_);
  }
...
template<>
inline
auto build<::stonefish_ros2::srv::SonarSettings_Event>()
{
  return stonefish_ros2::srv::builder::Init_SonarSettings_Event_info();
}
